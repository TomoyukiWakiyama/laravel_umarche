                          ...
                          <div class="lg:w-1/2 md:w-2/3 mx-auto">
                                ...
                                <form action="{{route( 'admin.owners.update', ['owner' => $owner->id] )}}" method="post">
                                    ...
                                    <div class="p-2 w-1/2 mx-auto">
                                        <div class="relative">
                                        <label for="name" class="leading-7 text-sm text-gray-600">オーナー名前</label>
                                    ...
                                    <div class="p-2 w-1/2 mx-auto">
                                        ...
                                        <div class="w-full text-base outline-none text-gray-700 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out">{{$owner->shop->name}}</div>
                                        </div>
                                    </div>
